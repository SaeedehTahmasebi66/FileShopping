	        					...
	        					<div class="list__view__wrapper">
	        						...
	        						<div class="list__view mt--40">
	        							<div class="thumb">
	        								...
	        								<a class="second__img animation1" href="{{'/single-product'}}"><img src="{{asset('assets/images/product/4.jpg')}}" alt="product images"></a>
	        							</div>
	        							<div class="content">
	        						...
	        						<div class="list__view mt--40">
	        							<div class="thumb">
	        								<a class="first__img" href="{{'/single-product'}}"><img src="{{asset('assets/images/product/3.jpg')}}" alt="product images"></a>
	        								<a class="second__img animation1" href="{{'/single-product'}}"><img src="{{asset('assets/images/product/6.jpg')}}" alt="product images"></a>
	        							</div>
	        							<div class="content">
	        						...
	        						<div class="list__view mt--40">
	        							<div class="thumb">
	        								<a class="first__img" href="{{'/single-product'}}"><img src="{{asset('assets/images/product/4.jpg')}}" alt="product images"></a>
	        								<a class="second__img animation1" href="{{'/single-product'}}"><img src="{{asset('assets/images/product/6.jpg')}}" alt="product images"></a>
	        							</div>
	        							<div class="content">
	        						...
	        						<div class="list__view mt--40">
	        							<div class="thumb">
	        								<a class="first__img" href="{{'/single-product'}}"><img src="{{asset('assets/images/product/5.jpg')}}" alt="product images"></a>
	        								<a class="second__img animation1" href="{{'/single-product'}}"><img src="{{asset('assets/images/product/9.jpg')}}" alt="product images"></a>
	        							</div>
	        							<div class="content">
