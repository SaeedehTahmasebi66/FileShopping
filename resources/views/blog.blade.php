        	...
        	<div class="container">
        		<div class="row">
        			<div class="col-lg-9 col-12">
        				<div class="blog-page">
        					...
        					<article class="blog__post d-flex flex-wrap">
        						...
        						<div class="content">
        							...
        							<div class="blog__btn">
        								<a href="/blog-details/{{$blog->id}}">ادامه مطلب</a>
        							</div>
        						</div>
                            </article>
                            @endforeach
                        ...
                        {{-- pagination --}}
                        <div style="margin:65px 520px 10px;">{{ $blogs->links() }}</div>
                        {{-- <ul class="wn__pagination">
                            <li><a href="#" style="transform: scaleX(-1);"><i class="zmdi zmdi-chevron-right"></i></a></li>
